...
// Reloj del panel: inicializar a la hora del servidor y actualizar cada segundo
(function() {
    // Timestamp inicial en ms inyectado desde el servidor
    ...
    // primera actualización inmediata y luego cada segundo
    updateClock();
